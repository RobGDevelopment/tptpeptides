...
export function ClinicOverviewTab({ data }: { data: PatientDashboardData }) {
  return (
    <div className="space-y-6">
      ...
      <DashboardCard title="Active Prescriptions">
        {data.prescriptions.length === 0 ? (
          <p className="text-sm text-muted font-light">
            No active prescriptions on file. Your provider will issue a treatment plan after intake
            approval.
          </p>
        ) : (
