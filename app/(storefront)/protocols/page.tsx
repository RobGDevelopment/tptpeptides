  ...
  return (
    <main className="min-h-screen bg-void selection:bg-gold/20 pt-28 pb-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 space-y-px bg-white/[0.04]">
          {protocols.map((protocol) => (
            <TerminalPanel key={protocol.id} className="p-8 lg:p-10 bg-void">
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8">
                <div className="max-w-2xl">
                  <h2 className="text-lg font-light text-primary tracking-title uppercase mb-4">
                    {protocol.title}
                  </h2>
        ...
        <div className="mt-16 text-center">
          <MetallicBeam variant="horizontal" className="mb-8 max-w-xs mx-auto" />
