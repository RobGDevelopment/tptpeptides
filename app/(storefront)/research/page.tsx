    ...
    <main className="min-h-screen bg-void selection:bg-gold/20 pt-28 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <PageHeader
          ...
          align="left"
        />
        <p className="text-secondary font-light mt-6 text-sm">
          Educational content for laboratory teams.
        </p>
        <MetallicBeam variant="horizontal" className="my-10" />
          ...
          {articles.map((article) => (
            ...
            >
              <TerminalPanel hoverBeam className="p-8">
                ...
                <h2 className="text-lg font-light text-primary mt-2 group-hover:text-gold-light transition-colors">
                  {article.title}
                </h2>
                <p className="text-sm text-secondary font-light mt-3">{article.excerpt}</p>
              </TerminalPanel>
            </Link>
          ))}
        </div>
